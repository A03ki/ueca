...
def diff_symbol(obj: PhysicsData, symbol: str, n: int) -> PhysicsData:
    ...
    return PhysicsData(sympy.diff(obj.magnitude, symbol, n), new_units)


@physicsdata_symbolic_exception
def exp(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.exp(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def log(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.log(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def ln(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.ln(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def sqrt(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.sqrt(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def sin(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.sin(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def cos(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.cos(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def tan(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.tan(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def asin(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.asin(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def acos(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.acos(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def atan(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.atan(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def sinh(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.sinh(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def cosh(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.cosh(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def tanh(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.tanh(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def asinh(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.asinh(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def acosh(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.acosh(obj.magnitude), obj.unit)


@physicsdata_symbolic_exception
def atanh(obj: PhysicsData) -> PhysicsData:
    return PhysicsData(sympy.atanh(obj.magnitude), obj.unit)
